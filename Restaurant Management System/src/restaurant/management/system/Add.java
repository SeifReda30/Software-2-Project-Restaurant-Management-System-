...
public class Add extends javax.swing.JFrame {
 ...
 try{
            ...
            Integer.parseInt(id.getText()); 
             int r = F.addcustomer( id.getText(), name.getText(), address.getText(), phonenumber.getText(), (marketing.isSelected()? "1" : "0"), 
                                    (lrprograms.isSelected()? "1" : "0") );
            if(r == 1) JOptionPane.showMessageDialog(null,"Customer has been added!","Success",JOptionPane.INFORMATION_MESSAGE);
            else       JOptionPane.showMessageDialog(null,"Customer has not been added!","Fail",JOptionPane.ERROR_MESSAGE);
